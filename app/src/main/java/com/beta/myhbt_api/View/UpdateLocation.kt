...
class UpdateLocation : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mapFragment = supportFragmentManager.findFragmentById(R.id.mapViewUpdateLocation) as? SupportMapFragment
        ...
        val mapFragmentLastUpdatedLocation = supportFragmentManager.findFragmentById(R.id.mapViewUpdateLocationLastKnownLocation) as? SupportMapFragment
