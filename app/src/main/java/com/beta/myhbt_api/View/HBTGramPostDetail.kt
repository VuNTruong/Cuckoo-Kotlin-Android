...
class HBTGramPostDetail : AppCompatActivity(), CreateNotificationInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        postOptionsMenu.setOnClickListener {
            ...
            val bottomSheet = PostOptionsMenu(this, selectedPostObject.getId())
    ...
    private fun createNewComment (commentContentToPostEditText: EditText, postId: String, commentReceiverUserId: String) {
        ...
        postRepository.createCommentForPost(commentContentToPostEditText.text.toString(), postId) {commentWriterId ->
            ...
            val newCommentObject = HBTGramPostComment(commentContentToPostEditText.text.toString(), commentWriterId, "")
    ...
    private fun getPostDetail (postId: String) {
        ...
        postViewModel.getPostDetail(postId) {arrayOfImages, arrayOfComments ->
            ...
            adapter = RecyclerViewAdapterHBTGramPostDetail(selectedPostObject, arrayOfImages, arrayOfComments, this@HBTGramPostDetail, this, this, executorService)
