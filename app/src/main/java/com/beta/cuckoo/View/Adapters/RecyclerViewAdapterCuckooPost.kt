...
class RecyclerViewAdapterCuckooPost (hbtGramPostObjects: ArrayList<CuckooPost>, activity: Activity,
    ...
    inner class ViewHolderHBTGramPost internal constructor(itemView: View) :
        ...
        fun setUpPostInfo (postObject: CuckooPost) {
    ...
    fun gotoPostDetail (postObject: CuckooPost) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (position in 0 until hbtGramPostObjects.size) {
            ...
            val hbtGramPostModel = gs.fromJson<CuckooPost>(js, CuckooPost::class.java)
