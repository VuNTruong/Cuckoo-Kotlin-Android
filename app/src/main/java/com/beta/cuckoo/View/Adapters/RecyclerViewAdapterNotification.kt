...
class RecyclerViewAdapterNotification (arrayOfNotifications: ArrayList<Notification>, activity: Activity, loadMorePostsInterface: LoadMorePostsInterface, executorService: ExecutorService) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    // The post repository
    ...
    fun getPostObjectBasedOnIdAndGotoPostDetail (postId: String) {
        postRepository.getPostObjectBasedOnId(postId) {postObject, postFound ->
            if (postFound) {
